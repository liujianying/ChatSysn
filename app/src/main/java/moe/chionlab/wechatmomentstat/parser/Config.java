...
public class Config {
    ...
    final static public String EXT_CRASH_DIR = Environment.getExternalStorageDirectory() + "/WeChatMomentStat/crash";
    ...
    final static public String[] VERSIONS = {"6.3.13.49_r4080b63", "6.3.13.64_r4488992", "6.3.16.49_r03ae324"};
    final static public String[] PROTOCAL_SNS_LOAD_CLASSES = {"com.tencent.mm.plugin.sns.d.ad", "com.tencent.mm.plugin.sns.d.ad"};
    final static public String[] PROTOCAL_SNS_LOAD_METHODS =  {"azg", "azg"};
    final static public String[] PROTOCAL_SNS_LOAD_CLASSES2 = {"com.tencent.mm.plugin.sns.d.ad", "com.tencent.mm.plugin.sns.d.ad"};
    final static public String[] PROTOCAL_SNS_LOAD_METHODS2 = {"ayQ", "ayQ"};
    ...
    static public String PROTOCAL_SNS_LOAD_CLASS;
    static public String PROTOCAL_SNS_LOAD_METHOD;
    static public String PROTOCAL_SNS_LOAD_CLASS2;
    static public String PROTOCAL_SNS_LOAD_METHOD2;
    ...
    static private void setConstants(int index) {
        PROTOCAL_SNS_LOAD_CLASS = PROTOCAL_SNS_LOAD_CLASSES[index];
        PROTOCAL_SNS_LOAD_METHOD = PROTOCAL_SNS_LOAD_METHODS[index];
        PROTOCAL_SNS_LOAD_CLASS2 = PROTOCAL_SNS_LOAD_CLASSES2[index];
        PROTOCAL_SNS_LOAD_METHOD2 = PROTOCAL_SNS_LOAD_METHODS2[index];
